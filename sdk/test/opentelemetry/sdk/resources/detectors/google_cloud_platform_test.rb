  ...
  describe '.detect' do
    ...
    describe 'when in a gcp environment' do
      before do
        ...
        mock.expect(:instance_attribute, 'us-central1', ['cluster-location'])
        mock.expect(:instance_zone, 'us-central1-a')
        mock.expect(:lookup_metadata, 'opentelemetry-test', ['instance', 'id'])
        mock.expect(:lookup_metadata, 'opentelemetry-test', ['instance', 'hostname'])
        mock.expect(:instance_attribute, 'opentelemetry-cluster', ['cluster-name'])
